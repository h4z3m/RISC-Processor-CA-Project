...
IADD R3, R2, 0100 				# this instruction should be at address 23h & 24h, 100 is hex format (256 decimal)
RTI							# this instruction should be at address 25h

.org 100
IN R1						# this instruction should be at address 100h
INC R1, r3						# this instruction should be at address 101h
...
.org 30
NOT  R4, r1					# this instruction should be at address 30H 
